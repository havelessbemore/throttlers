...
[throttlers](../globals.md) / TimeoutError

# Class: TimeoutError

Defined in: node\_modules/wait-utils/dist/esm/index.d.ts:19
...
Defined in: node\_modules/wait-utils/dist/esm/index.d.ts:20
